...
model = LogicRegression(learning_rate=0.01)
...
print(f"=== Training Performance ===: {train_f1, train_precision, train_recall} ")
print(f"=== Test Performance ===: {test_f1, test_precision, test_recall}")
